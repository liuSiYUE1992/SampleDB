...
const FileName = "sampleDB.data"
const MergeFileName = "SampleDB.data.merge"
...
func NewInternal(fileName string) (*DBFile, error) {
	file, error := os.OpenFile(fileName, os.O_CREATE|os.O_RDWR, 0644)
	if error != nil {
		return nil, error
	}
	...
	return &DBFile{Offset: stat.Size(),
		File: file,
	}, nil
}
